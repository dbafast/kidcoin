...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kidcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kidcointools.com", "dnsseed.kidcointools.com"},
    {"kidcoinpool.org", "dnsseed.kidcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"kidcointools.com", "testnet-seed.kidcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kidcoin is probably already running."), addrBind.ToString().c_str());
        else
